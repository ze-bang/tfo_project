...
runs={"gs1":"it14_gs1","gs2":"it14_gs2","gs3":"it14_gs3"}
...
fig.suptitle("it14 ACCEPTANCE RUN: dark mu13 drive (c5=0), w4=0.1, T1=0.08, thermal ensemble",fontsize=12)
fig.tight_layout(); fig.savefig(f"{BASE}/thermal_2dcs_it14_final.png",dpi=112)
print("\nsaved thermal_2dcs_it14_final.png")
