...
=S_x+0.913\lambda^7+4.4\lambda^6+0.006\lambda^4
+g_d(\langle F_x\rangle+\delta F_x)\lambda^2$ with
$\mu^x_{13}=0$---and the channel map is
...
$(E_{12},1.15)$ & $0.15$ & $0.04$ & self-reversal wing of the $E_{13}$ line\\
$(\qafm,1.41)$ & $0.30$ & $0.30$ & dynamical $d_z^{\rm eff}$
  ($\delta F_x\lambda^2$): sum tone at $\qafm{+}E_{12}$\\
$(\qafm,0.40)$ & obs. & $0.42$ & its difference tone
